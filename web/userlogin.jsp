...
<center>
		...
		<form method="post" action="/BTMS/selectsrcdest.jsp">
			<button type="submit" style="width: 500px; height: 100px; font-size : 30px;">
				<i>BOOK TICKETS</i>
			</button>
		</form><br><br><br>
		<form method="post" action="/BTMS/showmybookings.jsp">
			<button type="submit" style="width: 500px; height: 100px;font-size : 30px;">
		...
		<form method="post" action="/BTMS/showbus">
			<button type="submit" style="width: 500px; height: 100px;font-size : 30px;">
				<i>SHOW BUS DETAILS</i>
			</button>
		</form></br>
		</br><br><br>
		<form method="post" action="/BTMS/logoutsession">
