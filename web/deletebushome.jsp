...
%>
<form method="post" action="/BTMS/deletebusdetails">
<center><br><br><br>
    <h1 style="color: white; font-size: 40px;"> <i>SELECT YOUR BUS TO DELETE</i></h1><br><br><br>
        <label style="font-size: 30px;"><b><i>Details: </i></b></label><select name="bno" style="width:400px; height:25px; font-size:20px;">
        <%  while(rs.next()){ %>
  ...
  <input type="submit" style="width: 100px; height: 30px; font-size: 20px;" value="DELETE" onclick="window.location.href=/BTMS1/deletebusdetails.java" >
</center></form>
